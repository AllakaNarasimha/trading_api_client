...
set PACKAGE_FILE_NAME=trading-api-monitor-1.0.0.tar.gz
...
set TARBALL=
if exist "%DIST_DIR%\%PACKAGE_FILE_NAME%" (
    set TARBALL=%DIST_DIR%\%PACKAGE_FILE_NAME%
) else if exist "%SCRIPT_DIR%%PACKAGE_FILE_NAME%" (
    set TARBALL=%SCRIPT_DIR%%PACKAGE_FILE_NAME%
)
