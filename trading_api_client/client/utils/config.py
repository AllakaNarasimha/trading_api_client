...
class Config:
    ...
    def _load_config(self) -> None:
        ...
        if os.path.exists(self.config_file):
            ...
            logging.getLogger(__name__).info(f"Config file {self.config_file} not found. Using defaults.")
    ...
    def get_log_file_path(self, script_dir: str) -> str:
        """Get log file path."""
        return os.path.join(script_dir, 'option_chain_monitor_api.log')
